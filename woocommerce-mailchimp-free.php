...
if (in_array('woocommerce/woocommerce.php', apply_filters('active_plugins', get_option('active_plugins'))))
{
    ...
    function softsdev_mailchimp_settings()
    {
                ...
                <div class="postbox">
                    ...
                    <table width="100%" class="form-table">
                        <tr>
                            ...
                            <td>
                                <?php if( $softsdev_wc_mc_setting['api'] ) { ?>
                                    ...
                                    <span>
                                        <a href = "http://www.dreamfoxmedia.com/ufaq-category/wctmg-f/#utm_source=wp-plugin&utm_medium=wctmg&utm_campaign=questionmark" target="_blank">
                        ...
                        <tr style="display: <?php echo @$softsdev_wc_mc_setting['api'] ? '' : 'none' ?>">
                            <th width="170px">
                                <label for="softsdev_mailchimp_list"><?php echo __('Mailchimp List Name', 'softsdev') ?> </label>
                                    <a href = "http://www.dreamfoxmedia.com/ufaq-category/wctmg-f/#utm_source=wp-plugin&utm_medium=wctmg&utm_campaign=questionmark" target="_blank">
                                        <img style="margin-left:5px; vertical-align:middle" width="18" height="18" src="<?php echo plugins_url('images/help.png', __FILE__) ?>" class="help_tip" title="<?php echo __('Mailchimp List Name', 'softsdev'); ?>">
                                    </a>
                            </th>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <p>See also our other plugins at: <a href="http://www.dreamfoxmedia.com/plugin-portfolio/#utm_source=wp-plugin&utm_medium=wctmg&utm_campaign=portfolio">http://www.dreamfoxmedia.com</a></p>
        ...
        <div class="right-mc-setting">
            ...
            <h3>Woocommerce categories Mailchimp groups Premium</h3>
                <p>This plugin has also a Premium version with several powerful features. <a href="http://www.dreamfoxmedia.com/shop/woocommerce-categories-to-mailchimp-groups-plugin-premium/#utm_source=wp-plugin&utm_medium=wctmg&utm_campaign=portfolio">Take a look here</a>!</p>
            </div>
            ...
            <div class="wctmg-box" >
                <h4 class="wctmg-title"><?php echo __( 'Looking for help?', 'mailchimp-for-wp' ); ?></h4>
                <p><?php echo __( 'We have some resources available to help you in the right direction.', 'mailchimp-for-wp' ); ?></p>
                <ul class="ul-square">
                    <li><a href="http://www.dreamfoxmedia.com/ufaq-category/wctmg-f/#utm_source=wp-plugin&utm_medium=wctmg&utm_campaign=helpbar"><?php echo __( 'Knowledge Base', 'mailchimp-for-wp' ); ?></a></li>
                    <li><a href="https://wordpress.org/plugins/woocommerce-mailchimp-plugin/faq/"><?php echo __( 'Frequently Asked Questions', 'mailchimp-for-wp' ); ?></a></li>
                </ul>
                ...
                <p><?php echo sprintf( __( 'Found a bug? Please <a href="%s">open an issue on GitHub</a>.' ), 'https://github.com/dreamfoxnl/WC-categories-Mailchimp-groups-Free/issues' ); ?></p>
            </div>
